% Automated download of EC station data -- Octave-friendly version
...
save_dir = '/media/Stuff/Data/EC_Wx_tools/Data/'; % Location to save data files.
if isdir(save_dir)==0
mkdir(save_dir);
end
...
%% Main loop
for i = 1:1:size(station_ids,1) % Cycle through sites
  out = [];
